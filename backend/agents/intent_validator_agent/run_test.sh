...
# Script para rodar o endpoint de teste do Intent Validator Agent
...
echo -e "${BLUE}================================================================================${NC}"
echo -e "${BLUE}🧪 INTENT VALIDATOR TEST RUNNER${NC}"
echo -e "${BLUE}================================================================================${NC}"
...
case "$MODE" in
    server)
        echo -e "${GREEN}🚀 Iniciando servidor de teste na porta 5001...${NC}"
    ...
    test)
        ...
        echo ""
        python agents/intent_validator_agent/test_client.py test "$PERGUNTA" "$USERNAME" "$PROJETO"
        ;;
    ...
    help|*)
        ...
        echo ""
        echo -e "  ${BLUE}server${NC}           - Inicia o servidor de teste (porta 5001)"
        ...
        echo -e "  ./run_test.sh test \"Qual a receita de bolo?\" joao projeto_abc"
        echo ""
