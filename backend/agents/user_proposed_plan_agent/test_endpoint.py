...
if __name__ == '__main__':
    ...
    print("="*80)
    print(f"✅ Servidor rodando em: http://localhost:5011")
    print(f"📡 Endpoint de teste: POST http://localhost:5011/test-user-proposed-plan")
    print(f"❤️  Health check: GET http://localhost:5011/health")
    print(f"ℹ️  Info: GET http://localhost:5011/info")
    print("="*80 + "\n")
