...
if __name__ == '__main__':
    port = int(os.getenv('PLAN_BUILDER_PORT', 5009))
    print("\n" + "="*80)
    print("🧪 PLAN BUILDER TEST ENDPOINT")
    print("="*80)
    print(f"Servidor iniciado em: http://localhost:{port}")
    print("\nEndpoints disponíveis:")
    print(f"  POST   /test-plan-builder          - Testar construção de plano")
    print(f"  GET    /test-plan-builder/health   - Health check")
    print(f"  GET    /test-plan-builder/examples - Ver exemplos de uso")
    print("\n" + "="*80 + "\n")
