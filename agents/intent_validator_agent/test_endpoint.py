...
if __name__ == '__main__':
    port = int(os.getenv('INTENT_VALIDATOR_PORT', 5001))
    print("\n" + "="*80)
    print("🧪 INTENT VALIDATOR TEST ENDPOINT")
    print("="*80)
    print(f"Servidor iniciado em: http://localhost:{port}")
    print("\nEndpoints disponíveis:")
    print(f"  POST   /test-intent-validator          - Testar validação de intenção")
    print(f"  GET    /test-intent-validator/health   - Health check")
    print(f"  GET    /test-intent-validator/examples - Ver exemplos de uso")
    print("\n" + "="*80 + "\n")
